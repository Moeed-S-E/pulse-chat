          ...
          {isEditing ? (
            <div className="space-y-2 text-slate-900">
              <textarea
                ...
                className="w-full p-2 rounded-xl text-xs bg-white border border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-slate-900 resize-none"
                rows={2}
                autoFocus
              />
              <div className="flex justify-end space-x-2">
                ...
                <button
                  ...
                  className="px-2.5 py-1 text-[11px] font-bold text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg shadow-sm"
                >
                  Save
                </button>
              </div>
        ...
        {!msg.isDeleted && !isEditing && (
          ...
          >
            ...
            <button
              ...
              className="p-1 rounded-lg text-slate-500 hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-slate-700 transition-colors"
            >
    ...
    <div className="flex-1 overflow-y-auto p-3 sm:p-6 space-y-4 wa-chat-bg">
      ...
      {forwardModalMsg && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-white dark:bg-[#1E293B] rounded-3xl p-6 max-w-md w-full shadow-2xl border border-slate-200 dark:border-slate-700 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="font-extrabold text-slate-900 dark:text-slate-100 text-base flex items-center space-x-2">
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-2xl border border-slate-200 dark:border-slate-700/60 text-xs text-slate-700 dark:text-slate-300 italic max-h-24 overflow-y-auto">
              "{forwardText}"
            </div>
                    ...
                    <div
                      ...
                      className={`p-3 rounded-2xl cursor-pointer flex items-center justify-between border transition-all ${
                        isSelected
                          ...
                          : 'bg-white dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 hover:bg-slate-100'
                      }`}
                    >
            ...
            <div className="flex justify-end space-x-2 pt-2">
              ...
              <button
                ...
                className="px-5 py-2 text-xs font-extrabold text-white bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 rounded-xl shadow-md cursor-pointer"
              >
                Forward
              </button>
            </div>
