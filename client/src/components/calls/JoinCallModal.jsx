      ...
      <div className="w-full max-w-md bg-white rounded-3xl p-6 shadow-2xl border border-slate-100 relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2.5">
            <div className="w-10 h-10 rounded-2xl pulse-gradient-bg flex items-center justify-center text-white shadow-md shadow-pulse-blue/30">
        ...
        <div className="p-1 bg-slate-100 rounded-2xl flex items-center space-x-1 mb-5">
          ...
          >
            <AtSign className="w-3.5 h-3.5 text-pulse-blue" />
          ...
          >
            <Key className="w-3.5 h-3.5 text-pulse-blue" />
          ...
          <form onSubmit={handleCallUsername} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <AtSign className="w-5 h-5 text-pulse-blue absolute left-3.5 top-1/2 -translate-y-1/2" />
                <input
                  type="text"
                  autoFocus
                  value={usernameInput}
                  ...
                  required
                  className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:bg-white focus:border-pulse-blue focus:ring-4 focus:ring-pulse-blue/10 transition-all"
                />
              </div>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-2xl pulse-gradient-bg text-white font-bold text-sm shadow-lg shadow-pulse-blue/30 hover:opacity-95 active:scale-95 transition-all flex items-center justify-center space-x-2 disabled:opacity-50"
            >
        ...
        {activeTab === 'code' && (
          <form onSubmit={handleJoinByCode} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <Key className="w-5 h-5 text-pulse-blue absolute left-3.5 top-1/2 -translate-y-1/2" />
                <input
                  type="text"
                  autoFocus
                  value={codeInput}
                  ...
                  required
                  className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-extrabold uppercase text-slate-900 placeholder:text-slate-400 focus:outline-none focus:bg-white focus:border-pulse-blue focus:ring-4 focus:ring-pulse-blue/10 transition-all tracking-wider"
                />
              </div>
              <p className="text-[11px] font-medium text-slate-500 mt-1.5">
        ...
        {activeTab === 'instant' && (
          <div className="space-y-4 text-center py-2">
            <div className="w-14 h-14 rounded-3xl pulse-gradient-bg mx-auto flex items-center justify-center text-white shadow-xl shadow-pulse-blue/30">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-2xl pulse-gradient-bg text-white font-bold text-sm shadow-lg shadow-pulse-blue/30 hover:opacity-95 active:scale-95 transition-all flex items-center justify-center space-x-2"
            >
              <Video className="w-4 h-4 fill-white" />
